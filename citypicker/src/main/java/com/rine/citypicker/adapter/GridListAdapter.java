...
public class GridListAdapter<T> extends RecyclerView.Adapter<GridListAdapter.GridViewHolder>{
    ...
    public GridListAdapter(Context context, List<T> data) {
    ...
    public void onBindViewHolder(GridViewHolder holder, int position) {
        ...
        final City data = (City) mData.get(pos);
        if (data == null) return;
        //设置item宽高
